...
const PMDocProfile = () => {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.carddoctorInfo, styles.dividerPosition1]}>
        <View style={[styles.background, styles.starIconLayout]} />
        ...
        >
          ...
          <View style={[styles.rectangleParent, styles.groupPosition]}>
            <View style={[styles.groupItem, styles.starIconLayout]} />
            <Image
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/rectangle-20813.png")}
        />
        <Image
          style={[styles.carddoctorInfoItem, styles.childLayout]}
          contentFit="cover"
          source={require("../assets/ellipse-7532.png")}
        />
      </View>
...
Post Graduate Diploma in Postpartum Nutrition`}</Text>
      ...
      <Image
        style={styles.pmDocProfileItem}
        contentFit="cover"
        source={require("../assets/frame-51901.png")}
      />
    </Pressable>
  );
};
