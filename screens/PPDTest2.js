...
const PPDTest2 = () => {
  ...
  return (
    <View style={styles.ppdTest3}>
      <View style={[styles.image2, styles.imageLayout]} />
      <View style={styles.ppdTest3Inner}>
        <View style={[styles.frameParent, styles.frameParentSpaceBlock]}>
          <View style={styles.frameGroup}>
            ...
            <View style={styles.answer2Parent}>
              ...
              <View style={[styles.answer22, styles.answerLayout]}>
          ...
          <View style={styles.instanceParent}>
            <Pressable
              ...
              onPress={() => navigation.navigate("PPDTest1")}
            >
            ...
            >
              <Text style={[styles.next1, styles.nextTypo]}>Submit</Text>
            </Pressable>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.ppdTest3Child, styles.frameParentSpaceBlock]}>
