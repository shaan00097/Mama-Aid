    ...
    <View style={styles.workoutSummary}>
      <View style={styles.datePicker}>
        ...
        <View style={styles.days}>
          ...
          <Pressable
            style={[styles.day2, styles.dayLayout]}
            onPress={() => navigation.navigate("WorkoutSummary1")}
          >
            <View style={[styles.rectangle, styles.rectanglePosition]} />
      ...
      <View style={styles.graphics}>
        <View style={[styles.activeCalories, styles.timeChildPosition]}>
          ...
          />
          <Text style={[styles.text, styles.calLayout]}>745</Text>
        ...
        <View style={[styles.time, styles.timeLayout]}>
          ...
          <View style={styles.minWrapper}>
            <Text style={[styles.min, styles.minFlexBox]}>45 Min</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.time1, styles.timeLayout]}>
        ...
        <View style={styles.workoutsWrapper}>
          <Text style={[styles.min, styles.minFlexBox]}>4 Workouts</Text>
        </View>
      </View>
