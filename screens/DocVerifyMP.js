...
const DocVerifyMP = () => {
  ...
  return (
    <View style={styles.docVerifyMp1}>
      <Image
        style={styles.docVerifyMp1Child}
        contentFit="cover"
      ...
      >
        ...
        <Text style={styles.leadVisualDesigner1}>Paleo Diet Approval</Text>
      ...
      <View style={[styles.carddoctorInfo1, styles.carddoctorLayout]}>
        ...
        <Text style={styles.blakeGordon}>John Terry</Text>
        <Text style={styles.leadVisualDesigner}>+44 75 1314 8036</Text>
        <Text style={styles.leadVisualDesigner1}>Vegan Diet Approval</Text>
        <View style={styles.leadVisualDesignerParent}>
          <Text style={[styles.leadVisualDesigner2, styles.leadTypo]}>
            1000+ Patients
          </Text>
      ...
      <View style={[styles.carddoctorInfo2, styles.carddoctorLayout]}>
        ...
        <Text style={styles.blakeGordon}>John Terry</Text>
        <Text style={styles.leadVisualDesigner}>+44 75 1314 8036</Text>
        <Text style={styles.leadVisualDesigner1}> Keto Diet Approval</Text>
        <View style={styles.leadVisualDesignerParent}>
          <Text style={[styles.leadVisualDesigner2, styles.leadTypo]}>
            1000+ Patients
          </Text>
