...
const SignUpPM3 = () => {
  ...
  return (
    <View style={styles.signUpPm8}>
      <Text style={styles.profileSetUp}>Profile Set Up</Text>
      <Image
        style={styles.signUpPm8Child}
        contentFit="cover"
      ...
      <View style={[styles.inputField3, styles.inputBorder]}>
        <Text style={[styles.selectYourPostpartum, styles.text7Typo]}>
      ...
      <View style={[styles.inputField5, styles.inputField5Position]}>
        <Text style={[styles.selectYourPostpartum, styles.text7Typo]}>
          First 6 Months
        </Text>
        <Text style={[styles.text3, styles.textTypo1]}>repeat password</Text>
      ...
      <Text style={[styles.text7, styles.text7Typo]}>160</Text>
